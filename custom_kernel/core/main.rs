...
#[path = "../apps/tui_pm.rs"]
pub mod tui_pm;
#[path = "../apps/gui/mod.rs"]
pub mod gui;
#[path = "../apps/engine/mod.rs"]
pub mod engine;
pub mod debug;
pub mod security;
pub mod ipc;
    ...
    ($($arg:tt)*) => {
        {
            ...
            // Also print to VGA if possible
            $crate::drivers::video::put_str(&alloc::format!($($arg)*));
        }
    };
}
